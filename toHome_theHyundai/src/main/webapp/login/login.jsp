            ...
            <div class="innercon">
                ...
                <form name="memberLoginForm" action="${pageContext.request.contextPath}/cust/loginCustomer.do" method="post">
                    <fieldset class="form-field">
                        ...
                        <ul>
                            <li>
                                <label class="form-entry"><input type="text" id="customerId" name="customerId" class="big" title="아이디 입력" placeholder="아이디" value="" >    <!-- onkeydown="javascript:fn.inputMsgClear(#id);" -->
                        ...
                        <ul class="btn-group login-support">
                            ...
                            <li><a href="${pageContext.request.contextPath}/login/findIdPwd.jsp" >아이디/비밀번호 찾기</a> <!--여기 경로 넣기-->
                            </li>
                        </ul>
